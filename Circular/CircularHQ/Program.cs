...
try
{
    ...
    CircularHQ.Static.AppSettings.ChallengeUrl = builder.Configuration.GetSection("Challange").Value;
    CircularHQ.Static.AppSettings.ServerTimeZone = builder.Configuration.GetSection("ServerTimeZone").Value;
    CircularHQ.Static.AppSettings.DefaultUserTimeZone = builder.Configuration.GetSection("DefaultUserTimeZone").Value;
    ...
    builder.Services.AddScoped<ICommunityManagementRepository, CommunityManagementRepository>(provider => new CommunityManagementRepository(connectionString,
           provider.GetRequiredService<IHelper>(), provider.GetRequiredService<IHttpContextAccessor>()));
    builder.Services.AddScoped<ICommunityManagementService, CommunityManagementService>();
