...
try
{
    ...
    builder.Services.AddScoped<IExeederRepository, ExeederRepository>(provider => new ExeederRepository(connectionString));
    builder.Services.AddScoped<IExeederService, ExeederService>();
    ...
    {
        options.LoginPath = "/Exeeder/Exeeder/";
    });
    ...
    app.MapControllerRoute(
        name: "default",
        pattern: "{controller=Exeeder}/{action=Exeeder}/{id?}");
