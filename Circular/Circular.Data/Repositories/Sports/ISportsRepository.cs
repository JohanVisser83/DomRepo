...
namespace Circular.Data.Repositories.Sports
{
    public interface ISportsRepository
    {
        ...
        Task<bool> AddNewFixture(string SpotlightTitle, DateTime Time, string Location, long SportId, string HomeTeam, string AwayTeam,long SportTypeId);
        ...
        public Task<List<SportsTeamMember>> GetAddedTeamMemberAsync(long Id);
