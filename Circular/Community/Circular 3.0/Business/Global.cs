...
namespace CircularWeb.Business
{
    public class Global : IGlobal
    {
        ...
        public Global(IHttpContextAccessor _httpContextAccessor, IConfiguration _config, ICustomerRepository _customerRepository)
        {
            ...
            currentUser.Id = Id;
            currentUser.CustomerInfo = _customerRepository.getCommunityMemberDetailsById(currentUser.Id);
            ...
            currentUser.SubscriptionStatus = currentUser.CustomerInfo.SubscriptionStatus;
