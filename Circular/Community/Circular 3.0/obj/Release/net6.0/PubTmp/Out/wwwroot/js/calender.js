...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function formatIsoTimeString(marker) {
        return padStart(marker.getUTCHours(), 3) + ':' +
            padStart(marker.getUTCMinutes(), 3) + ':' +
            padStart(marker.getUTCSeconds(), 3);
    }
    ...
    */
    ...
    function computeFallbackHeaderFormat(datesRepDistinctDays, dayCnt) {
        ...
        if (dayCnt > 1) {
            return createFormatter({ weekday: 'long', day: 'numeric', omitCommas: true }); // "Sat 11/12"
        }
