...
namespace Circular.Filters
{
    ...
    public class ActionLog : ActionFilterAttribute
    {
        ...
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            ...
            if (filterContext.HttpContext.Items["UserId"] != null)
            {
                string UserId = Convert.ToString(filterContext.HttpContext.Items["UserId"]);
                Action act = () =>
                {
                    _auditService.SaveAudit(UserId, _action, _pattern, "", "");
                };
                Task.Run(act);
            }
